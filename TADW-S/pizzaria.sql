...
CREATE TABLE IF NOT EXISTS `pizzaria`.`usuario` (
  ...
  `tipo` ENUM('cliente', 'adm') NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`delivery` (
  ...
  `tempo_entrega_min` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`pagamento` (
  ...
  `metodo_pagamento` ENUM('pix', 'cartao debito', 'cartao credito', 'dinheiro') NOT NULL,
